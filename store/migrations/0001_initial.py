# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-01-24 23:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=datetime.datetime(2018, 1, 25, 0, 25, 31, 610372), editable=False, verbose_name='date brand was added to db')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=datetime.datetime(2018, 1, 25, 0, 25, 31, 615389), editable=False, verbose_name='date cart product was added to db')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=datetime.datetime(2018, 1, 25, 0, 25, 31, 616389), editable=False, verbose_name='date ordered')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=datetime.datetime(2018, 1, 25, 0, 25, 31, 618388), editable=False, verbose_name='date ordered')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='date order details were updated last')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', autoslug.fields.AutoSlugField(editable=False, populate_from='name', sep='', unique=True)),
                ('created_at', models.DateTimeField(default=datetime.datetime(2018, 1, 25, 0, 25, 31, 613388), editable=False, verbose_name='date added')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=datetime.datetime(2018, 1, 25, 0, 25, 31, 612390), editable=False, verbose_name='date product category was added to db')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=datetime.datetime(2018, 1, 25, 0, 25, 31, 618388), editable=False, verbose_name='date image was added to db')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=datetime.datetime(2018, 1, 25, 0, 25, 31, 611373), editable=False, verbose_name='date added')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(default=datetime.datetime(2018, 1, 25, 0, 25, 31, 615389), editable=False, verbose_name='date wish was added to db')),
