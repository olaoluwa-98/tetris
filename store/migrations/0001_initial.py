# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-03-04 19:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', phonenumber_field.modelfields.PhoneNumberField(default='True', help_text='Please use the following format: <em>+234 XXX XXX XXXX</em>.', max_length=128)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='date ordered')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='date order details were updated last')),
                ('order', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='order_items', to='store.Order', verbose_name='order')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('background-image', 'Background Image (1366px by 738px )'), ('default-product-img', 'Default Product Image (should be a perfect square)'), ('default-brand-img', 'Default Brand Image (should be a perfect square)'), ('default-category-img', 'Default Category Image (should be a perfect square)')], max_length=30, verbose_name='name of the image')),
                ('description', models.TextField(blank=True, null=True, verbose_name='description of the image')),
                ('image_url', models.ImageField(blank=True, max_length=255, upload_to='img/tetris-img/')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='date image was added to db')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='date image was updated last')),
            ],
        ),
