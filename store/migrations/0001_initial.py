# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-01-26 07:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=datetime.datetime(2018, 1, 26, 8, 29, 7, 425983), editable=False, verbose_name='date brand was added to db')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=datetime.datetime(2018, 1, 26, 8, 29, 7, 428984), editable=False, verbose_name='date cart product was added to db')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=datetime.datetime(2018, 1, 26, 8, 29, 7, 429982), editable=False, verbose_name='date ordered')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=datetime.datetime(2018, 1, 26, 8, 29, 7, 430983), editable=False, verbose_name='date ordered')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='date order details were updated last')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', autoslug.fields.AutoSlugField(editable=False, populate_from='name', sep='', unique=True)),
                ('created_at', models.DateTimeField(default=datetime.datetime(2018, 1, 26, 8, 29, 7, 427983), editable=False, verbose_name='date added')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='date product details were updated last')),
                ('admin', models.ForeignKey(blank=True, null=True, on_delete=models.SET(store.models.get_sentinel_user), related_name='products', to=settings.AUTH_USER_MODEL, verbose_name='Staff')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', autoslug.fields.AutoSlugField(editable=False, populate_from='name', sep='', unique=True)),
                ('created_at', models.DateTimeField(default=datetime.datetime(2018, 1, 26, 8, 29, 7, 426982), editable=False, verbose_name='date product category was added to db')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=datetime.datetime(2018, 1, 26, 8, 29, 7, 430983), editable=False, verbose_name='date image was added to db')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=datetime.datetime(2018, 1, 26, 8, 29, 7, 426982), editable=False, verbose_name='date added')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(default=datetime.datetime(2018, 1, 26, 8, 29, 7, 428984), editable=False, verbose_name='date wish was added to db')),
